                ...
                <div className="flex justify-between items-center gap-4 p-2">
                    <div className="flex flex-col gap-2 flex-1">
                        ...
                        <p className={`${isSelectedEnglish ? "text-left" : "text-right"} ${!isSelectedEnglish ? "leading-[48px]" : ""} mt-4 text-[16px] text-[${isDarkTheme ? "#fff" : "0A101D"}]`}>
                            {
                                isSelectedEnglish ?
                                    "Experience the best in travel with The Bus Linker, where comfort meets efficiency. Ensuring you reach your destination relaxed and on time."
                                    : "The Bus Linker کے ساتھ سفر میں بہترین تجربہ کریں، جہاں سکون کارکردگی کو پورا کرتا ہے۔ اس بات کو یقینی بنانا کہ آپ آرام سے اور وقت پر اپنی منزل پر پہنچیں۔"
                            }
                        </p>
                        {
