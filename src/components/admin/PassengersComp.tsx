                        ...
                        passengers?.map((passenger: any) => (
                            <>
                                <tr className="border border-b border-[#ccc]" key={passenger?._id}>
                                    ...
                                    // onClick={() => navigate(`/admin/passengers/${passenger?._id}`)}
                                    >
                                        <p className={`${passenger?.isPaid ? "bg-[#28A745]" : "bg-[#D61717]"} w-[100px] h-[33px] rounded-[100px] flex justify-center items-center text-[#fff] text-center text-sm mx-auto`}>{passenger?.isPaid ? "Paid" : "Un-Paid"}</p>
                                    </td>
                                    {/* <td className="cursor-pointer text-center p-[8px] py-[12px] text-[20px]">
                                        <p
                                            className="font-bold"
