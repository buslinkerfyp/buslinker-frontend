...
const BusRoutes = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            await axios.post(`${baseUrl}/api/v1/bus-route/${location?.state?.bus?._id}`, {
    ...
    const delRoute = async (_id: string) => {
        ...
        try {
            setIsLoading(true)
            await axios.delete(`${baseUrl}/api/v1/bus-route/${_id}`, {
                withCredentials: true
            })
            setIsLoading(false)
            getRoutes()
    ...
    const _editRoute = async (_id: string) => {
        ...
        try {
            setIsLoading(true)
            await axios.put(`${baseUrl}/api/v1/bus-route/${_id}`, {
